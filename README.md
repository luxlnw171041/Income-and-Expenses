...
## ทดลองใช้ทันที (ไม่ต้องตั้งค่าอะไร)
เปิดไฟล์ `index.html` ในเบราว์เซอร์ได้เลย แอปจะรันด้วย **ข้อมูลจำลอง (Mock Mode)**
ให้ลองกดทุกหน้าจอ ทุกปุ่มได้จริง เพื่อดูว่า UI/UX เป็นอย่างไรก่อนต่อฐานข้อมูลจริง
